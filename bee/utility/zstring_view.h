...
namespace bee {
    ...
    public:
        ...
        basic_zstring_view(CharT const* s, size_type sz): string_view_base { s, sz } { assert(s[sz] == 0); }
        basic_zstring_view(std::basic_string<CharT, Traits> const& s): string_view_base { s } { }
    private:public:
