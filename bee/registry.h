...
public:
    ...
    static hkey_type dup_key(hkey_type hkey,
                             REGSAM samDesired = KEY_ALL_ACCESS,
                             result_type *result = NULL);
    static result_type open_key(hkey_type hkey,
                                char_type const *sub_key_name,
                                hkey_type *hkey_result,
                                REGSAM samDesired = KEY_ALL_ACCESS);
    static result_type create_key(hkey_type hkey,
                                  char_type const *sub_key_name,
                                  hkey_type *hkey_result,
                                  REGSAM samDesired = KEY_ALL_ACCESS);
    static result_type create_key(hkey_type hkey,
    ...
    static result_type query_value(hkey_type hkey,
                                   char_type const *valueName,
                                   uint32_t &valueType,
                                   void *data,
                                   size_type &cbData);
    static result_type set_value(hkey_type hkey,
                                 char_type const *valueName,
                                 uint32_t valueType,
                                 void const *data,
                                 size_type cbData);
...
public:
    ...
    static result_type create_key(hkey_type hkey,
                                  ...
                                  hkey_type *hkey_result,
                                  REGSAM samDesired = KEY_ALL_ACCESS) {
        return ::RegCreateKeyExA(hkey, sub_key_name, 0, NULL, 0, samDesired, NULL,
                                 hkey_result, NULL);
    }
    ...
    static result_type create_key(hkey_type hkey,
        ...
        DWORD disposition;
        result_type res =
            ::RegCreateKeyExA(hkey, sub_key_name, 0, NULL, 0, samDesired, NULL,
                              hkey_result, &disposition);
    ...
    static result_type query_value(hkey_type hkey,
        ...
        return ::RegQueryValueExA(
            hkey, valueName, NULL, reinterpret_cast<LPDWORD>(&valueType),
            static_cast<LPBYTE>(data), reinterpret_cast<LPDWORD>(&cbData));
    }
    ...
    static result_type set_value(hkey_type hkey,
                                 ...
                                 void const *data,
                                 size_type cbData) {
        return ::RegSetValueExA(hkey, valueName, 0, valueType,
    ...
    static result_type query_info(hkey_type hkey,
        ...
        return ::RegQueryInfoKeyA(
            hkey, key_class, reinterpret_cast<LPDWORD>(cch_key_class), NULL,
            reinterpret_cast<LPDWORD>(c_sub_keys),
            reinterpret_cast<LPDWORD>(cch_sub_key_max),
            reinterpret_cast<LPDWORD>(cch_key_class_max),
            reinterpret_cast<LPDWORD>(c_values),
            reinterpret_cast<LPDWORD>(cch_valueName_max),
            reinterpret_cast<LPDWORD>(cb_value_data_max),
    ...
    static result_type enum_key(hkey_type hkey,
                                ...
                                size_type *cch_key_name,
                                time_type *time_last_write = NULL) {
        return ::RegEnumKeyExA(hkey, index, key_name,
                               reinterpret_cast<LPDWORD>(cch_key_name), NULL, NULL,
                               NULL, time_last_write);
    }
    ...
    static result_type enum_key(hkey_type hkey,
        ...
        return ::RegEnumKeyExA(
            hkey, index, key_name, reinterpret_cast<LPDWORD>(cch_key_name), NULL,
            key_class, reinterpret_cast<LPDWORD>(cch_key_class), time_last_write);
    }
    ...
    static result_type enum_value(hkey_type hkey,
        ...
        return ::RegEnumValueA(
            hkey, index, valueName, reinterpret_cast<LPDWORD>(cch_valueName), NULL,
            reinterpret_cast<LPDWORD>(valueType), reinterpret_cast<LPBYTE>(data),
            reinterpret_cast<LPDWORD>(&cbData));
    }
    ...
    static result_type enum_value(hkey_type hkey,
                                  ...
                                  char_type *valueName,
                                  size_type *cch_valueName) {
        return ::RegEnumValueA(hkey, index, valueName,
                               reinterpret_cast<LPDWORD>(cch_valueName), NULL, NULL,
                               NULL, NULL);
    }
...
private:
    static result_type execute_dynamic_(const char *module,
                                        const char *function,
                                        hkey_type a1,
                                        char_type const *a2) {
...
public:
    ...
    static result_type create_key(hkey_type hkey,
                                  ...
                                  hkey_type *hkey_result,
                                  REGSAM samDesired = KEY_ALL_ACCESS) {
        return ::RegCreateKeyExW(hkey, sub_key_name, 0, NULL, 0, samDesired, NULL,
                                 hkey_result, NULL);
    }
    ...
    static result_type create_key(hkey_type hkey,
        ...
        DWORD disposition;
        result_type res =
            ::RegCreateKeyExW(hkey, sub_key_name, 0, NULL, 0, samDesired, NULL,
                              hkey_result, &disposition);
        bCreated = (ERROR_SUCCESS == res) && (REG_CREATED_NEW_KEY == disposition);
        return res;
    }
    ...
    static result_type set_value(hkey_type hkey,
                                 ...
                                 void const *data,
                                 size_type cbData) {
        return ::RegSetValueExW(hkey, valueName, 0, valueType,
                                static_cast<BYTE const *>(data),
                                static_cast<DWORD>(cbData));
    }
    ...
    static result_type enum_key(hkey_type hkey,
                                ...
                                size_type *cch_key_name,
                                time_type *time_last_write = NULL) {
        return ::RegEnumKeyExW(hkey, index, key_name,
                               reinterpret_cast<LPDWORD>(cch_key_name), NULL, NULL,
                               NULL, time_last_write);
    }
    ...
    static result_type enum_value(hkey_type hkey,
                                  ...
                                  char_type *valueName,
                                  size_type *cch_valueName) {
        return ::RegEnumValueW(hkey, index, valueName,
                               reinterpret_cast<LPDWORD>(cch_valueName), NULL, NULL,
                               NULL, NULL);
    }
...
template <typename C, typename T, typename K>
inline typename basic_value<C, T, K>::string_type basic_value<C, T, K>::name()
    const {
    return m_name;
}
    ...
    if (data_size > 0) {
        ...
        res =
            traits_type::query_value(m_key.handle(open_access::read),
                                     m_name.c_str(), dw, buffer.data(), data_size);
...
inline uint32_t basic_value<C, T, K>::get_uint32_t() const {
    ...
    uint32_t value_type;
    result_type res =
        traits_type::query_value(m_key.handle(open_access::read), m_name.c_str(),
                                 value_type, &dwValue, cbData);
...
template <typename C, typename T, typename K>
inline bool basic_value<C, T, K>::set(uint32_t type,
                                      void const *value,
                                      size_type length) {
    result_type res = traits_type::set_value(m_key.handle(open_access::write),
                                             m_name.c_str(), type, value, length);
...
public:
    ...
    basic_key(hkey_type keybase,
              const string_type &keypath,
              const string_type &keyname,
              open_access accessfix = open_access::none)
        : m_keybase(keybase),
          m_keypath(keypath),
          m_keyname(keyname),
          m_key(NULL),
    ...
    class_type sub_key(const string_type &sub_key_name) const {
        ...
        if (!m_keypath.empty()) {
            return class_type(m_keybase, m_keypath + s_separator + m_keyname,
                              sub_key_name, m_accessfix);
    ...
    bool del() {
        hkey_type key = open_key_(m_keybase, m_keypath.c_str(),
                                  (REGSAM)open_access::write | (REGSAM)m_accessfix,
                                  open_option::fail_if_not_exists);
        if (key == NULL) {
            return false;
        }
...
protected:
        ...
        if (access == open_access::write) {
            ...
            if (m_key) {
                if (m_access == open_access::write) {
                    ...
                    close_key_();
                    key = open_key_(m_keybase, key_name_(),
                                    (REGSAM)access | (REGSAM)m_accessfix, option);
                }
            } else {
                key = open_key_(m_keybase, key_name_(),
                                (REGSAM)access | (REGSAM)m_accessfix, option);
    ...
    static hkey_type open_key_(hkey_type key_parent,
                               const string_type &key_name,
                               REGSAM access_mask,
                               open_option option) {
        if (option == open_option::fail_if_not_exists) {
            hkey_type hkey;
            result_type res = traits_type::open_key(key_parent, key_name.c_str(),
                                                    &hkey, access_mask);
            ...
            hkey_type hbasekey;
            hkey_type hkey;
            result_type res = traits_type::open_key(key_parent, s_empty_string,
                                                    &hbasekey, KEY_CREATE_SUB_KEY);
            check_and_throw_exception("could not open key", res);
            res = traits_type::create_key(hbasekey, key_name.c_str(), &hkey,
                                          access_mask);
...
inline basic_key<C, T> operator/(
    const basic_key<C, T> &lhs,
